<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateInput" aria-describedby="error1"/>
      <p id="error1"  v-if="userNameValidity === 'invalid'">Please enter valid name</p>
    </div>
    ...
    <div>
      <input type="checkbox" name="confirm" id="conform" v-model="confirm">
      <label for="confirm">Agree to terms and condition</label>
    </div>
    <div>
